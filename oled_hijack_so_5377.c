/*
 * Advanced OLED menu for Huawei E5377 portable LTE router.
 * 
 * Compile:
 * arm-linux-androideabi-gcc -shared -ldl -fPIC -O2 -s \
 * -D__ANDROID_API__=9 -DMENU_UNLOCK -DNET_UPDOWN -o oled_hijack.so oled_hijack_so_5377.c
 *
 ...
 * information screen.
 * 
 * Current values are based on E5377 21.292.99.08.00 oled binary.
 * MD5:  0ea9be562e3d267e781c1fd423f3a167
 * SHA1: a413e0fc8ae7e98081b7115e6fc270d7d1eedd1b
 * 
 */
static uint32_t volatile *g_current_page = (uint32_t volatile *)(0x0003A2AC);
static uint32_t volatile *g_current_Info_page = (uint32_t volatile *)(0x000414D8); 
static uint32_t volatile *g_led_status = (uint32_t volatile *)(0x0003A2D0); 
